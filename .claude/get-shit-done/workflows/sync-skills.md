...
INSTALL_JS_GLOBAL="/Users/andreabernardini/ai-projects/new-sparter-app/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/andreabernardini/ai-projects/new-sparter-app/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
