...
- **Global scope**: `/Users/andreabernardini/ai-projects/new-sparter-app/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/andreabernardini/ai-projects/new-sparter-app/.claude/notes/`)
...
2. Glob `/Users/andreabernardini/ai-projects/new-sparter-app/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/andreabernardini/ai-projects/new-sparter-app/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/andreabernardini/ai-projects/new-sparter-app/.claude/notes/` — works in any directory
