...
```
Task(
  prompt="Read /Users/andreabernardini/ai-projects/new-sparter-app/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/andreabernardini/ai-projects/new-sparter-app/.claude/get-shit-done/templates/VALIDATION.md`
