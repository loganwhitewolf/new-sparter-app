...
- Usage: Reference from command with `@/Users/andreabernardini/ai-projects/new-sparter-app/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/andreabernardini/ai-projects/new-sparter-app/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/andreabernardini/ai-projects/new-sparter-app/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
