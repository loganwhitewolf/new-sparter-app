...
<required_reading>
Read `/Users/andreabernardini/ai-projects/new-sparter-app/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
