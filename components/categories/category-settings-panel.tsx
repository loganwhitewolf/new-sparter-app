              ...
              <div className="min-w-0">
                ...
                {subCategory.hasOverride ? (
                  <p className="mt-1 text-xs text-muted-foreground">
                    Nome originale: {subCategory.originalName}. Questo nome vale
                    solo per te.
                  </p>
                ) : !subCategory.isOwned ? (
                  <p className="mt-1 text-xs text-muted-foreground">
                    Puoi creare un nome personale senza modificare la tassonomia
                    di sistema.
                  </p>
                ) : null}
              </div>
    ...
    <Card>
      <CardHeader className="gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <CardDescription>
            Seleziona una categoria per visualizzare e modificare le sue
            sottocategorie.
          </CardDescription>
        </div>
        <CreateCategoryDialog />
            ...
            <div className="min-w-0">
              {selectedCategory ? (
                ...
                <p className="text-sm text-muted-foreground">
                  Seleziona una categoria dalla lista.
                </p>
              )}
            </div>
          </div>
