...
```
Task(
  prompt="Read /Users/andreabernardini/ai-projects/new-sparter-app/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/andreabernardini/ai-projects/new-sparter-app/.codex/get-shit-done/templates/SECURITY.md`
