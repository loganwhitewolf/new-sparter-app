...
---
*Last updated: 2026-07-27 — milestone v2.8 Phase 76 (reimbursements-section) complete: dedicated `/reimbursements` list + per-reimbursement page (edit-title / add-remove-refund / delete in place) reusing the `/tags/[id]` + `ReimbursementPanel` scaffolding, transactions row-indicator deep-link, `/transactions/[id]` summary variant, "Rimborsi" sidebar entry; RMB-10/RMB-11 verified, full suite green (149 files, 1833 tests); two UAT gap fixes (no-404 redirect on removal, refund-title rewrite removed). All v2.8 phases 73–76 complete — milestone ready for `/gsd-complete-milestone v2.8`*
