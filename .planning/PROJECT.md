...
---
*Last updated: 2026-07-24 — milestone v2.8 Phase 74 (group-anchor-and-reconciliation) complete: `effectiveAmount()` proportional-spread for Expense/Group anchors (N=1 inert, regression gate green), residual as a computed Decimal-safe value (owed/settled/surplus), amount-edit guard generalized to protect Group anchors (gap-closure closed CR-01/CR-02 + a latent correlated-subquery bug caught by the first real-Postgres test against updateTransaction()); RMB-02/06/09 verified 9/9, full suite green (144 files, 1778 tests); linking surfaces → Phase 75, /reimbursements section → Phase 76*
