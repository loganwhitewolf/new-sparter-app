...
**Status:** ✅ SHIPPED 2026-07-22 (tag `v2.7`). All 10 requirements (TAG-06…TAG-15) validated — none adjusted or dropped. Deferred: TAG-F1 (per-tag trend/sparkline), TAG-F2 (CSV export from the tag page).
