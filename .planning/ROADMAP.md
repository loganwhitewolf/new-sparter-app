...
- [x] 73-01-PLAN.md — Tracer hub `/proto/branding` + switcher + Variant A (shot-as-plane) + fonts/placeholder

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 73-02-PLAN.md — Variants B (editorial split) + C (type-led stack) for full BRAND-01 compare
...
**Active on this branch: v2.9 Public Branding (Phase 74). Main-line milestone: v2.8 Reimbursements.**
