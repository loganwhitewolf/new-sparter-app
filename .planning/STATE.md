...
| 260708-jt6 | Fix description/title cell overflow in transactions+expenses tables (missing min-w-0 / table-fixed broke CSS truncate chain) | 2026-07-08 | pending |
