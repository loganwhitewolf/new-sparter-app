...
- [ ] **GRP-04**: User can open a group detail page showing subcategory, member expenses with original titles/totals, and the combined transaction list; rename lives here
