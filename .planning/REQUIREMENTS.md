...
- [x] **BRAND-03**: Anonymous visitor sees marketing pages under a dedicated `(public)` layout (header/nav/footer) without AppShell, sidebar, or onboarding gate
...
| BRAND-03 | 74. public-layout-and-proxy-allowlist | Complete |
