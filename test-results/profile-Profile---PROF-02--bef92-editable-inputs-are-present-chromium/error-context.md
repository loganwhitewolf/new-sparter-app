...
- Name: profile.spec.ts >> Profile - PROF-02: editable form fields >> PROF-02 six labeled editable inputs are present
- Location: tests/profile.spec.ts:26:7
...
Locator: getByLabel('Nome', { exact: true })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByLabel('Nome', { exact: true })
