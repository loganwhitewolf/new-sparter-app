...
- Name: profile.spec.ts >> Profile - PROF-03: read-only account fields >> PROF-03 role is visible but not an editable input
- Location: tests/profile.spec.ts:78:7
...
Call log:
  ...
  - waiting for locator('#account-role')
