...
- Name: expenses.spec.ts >> S04 searchable category combobox >> single categorize dialog: confirm button enables after selecting a subcategory
- Location: tests/expenses.spec.ts:142:7
