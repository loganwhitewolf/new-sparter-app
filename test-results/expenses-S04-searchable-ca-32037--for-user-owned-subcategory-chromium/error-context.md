...
- Name: expenses.spec.ts >> S04 searchable category combobox >> single categorize dialog: Personale badge visible for user-owned subcategory
- Location: tests/expenses.spec.ts:112:7
