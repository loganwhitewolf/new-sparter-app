...
- **Vacanze** — alloggio, trasporto, assicurazione-viaggio (tutte D). _(agg. 2026-07-28: allineato all'audit Phase 67 TAG-06/D-11 — `attivita-e-intrattenimento` e `cibo-e-bevande` sono disattivate. La categoria contiene **solo spesa intrinsecamente di viaggio**; tutto il resto si categorizza per oggetto anche se speso in viaggio.)_
